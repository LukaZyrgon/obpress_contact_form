...
final class OBPress_Contact_Form_Widget {
	/**
	 * Plugin Version
	 *
	 * @since 1.0.0
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Elementor Test Extension', 'OBPress_Contact_Form' ) . '</strong>',
	...
	public function init_widgets() {
		...
		require_once(WP_PLUGIN_DIR . '/OBPress_Contact_Form/widgets/demo-contact-form.php');


		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Demo_Contact_Form() );
...
OBPress_Contact_Form_Widget::instance();